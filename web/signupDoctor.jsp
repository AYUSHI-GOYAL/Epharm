<%-- 
    Document   : signupDoctor
    Created on : Feb 9, 2018, 10:12:41 PM
    Author     : Rajiv
--%>
...
<html>
    <head>
        ...
        <title>signup doctor | e-pharm</title>
       <!--<link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-CONTENT/signupDoctor.css" />-->
    ...
    <body bgcolor="D8FCB7">
        ...
        <font color="black" size="6">
            ...
            <form method="post" action="sdoctor.jsp"  name="f" id="example1">
                
                Create your e-pharm account !<br>  
                ...
                <input id="speciality" type="text" placeholder="Expertise Area" name="speciality" size="50"/> 
                <input id="experience" type="text" placeholder="Experience" name="experience" size="50"/> 
                <input id="hospital" type="text" placeholder="Works at" name="hospital" size="50"/> 
