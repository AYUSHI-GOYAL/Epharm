...
<html>
    ...
    <body bgcolor="D8FCB7">
        ...
        <img src="WEB-CONTENT/Zoloft.jpg" class="image" alt="Zoloft" style="width:300px;height:310px;border:0">
        
        <font class="myfont" color=black>   
          ZOLOFT 
        </font>
        <font class="myfont1" color=black> 
            <br> 100mg: 30 tablets = Rs. 10,827.83
            <br> 25mg :	30 tablets = Rs. 10,955.97
            <br> 50mg : 30 tablets = Rs. 16,337.85
        </font>
        <form method="post" action="shopping_bag.jsp" name="f" id="example1">
            <font size="5">
            <p align="left">
                &nbsp; &nbsp; <strike> Rs. 11,000.0 </strike>
             </p>
            </font>
            <font class="price">            
                Rs. 10,827.83
            ...
            <button type="submit" class="button button2" onclick="myFunction()">Add to Cart</button>
             <% session.setAttribute("product_name","Zoloft"); %>
        </form>
        <script>
                function myFunction(){
                    alert("Product added !");
