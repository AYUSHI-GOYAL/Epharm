...
<html>
    ...
    <body bgcolor="D8FCB7">
        ...
        <img src="WEB-CONTENT/lipitor.jpg" class="image" alt="Lipitor" style="width:300px;height:310px;border:0">
        
        <font class="myfont" color=black>   
            LIPITOR            
        </font>
        <font class="myfont1" color=black> 
            <br>1 bottle (90 tablets) : 20 mg
        </font>
        <form method="post" action="shopping_bag.jsp" name="f" id="example1">
            <font size="5">
            <p align="left">
                &nbsp; &nbsp; <strike> Rs. 6695.67 </strike>
             </p>
            </font>
            <font class="price">            
                Rs. 5,246.67  
            ...
            <button type="submit" class="button button2" onclick="myFunction()">Add to Cart</button>
             <% session.setAttribute("product_name","lipitor"); %>
        </form>
        <script>
                function myFunction(){
                    alert("Product added !");
        ...
        <form id="example2">
            ...
            <font size="3">
            <p align="left">
            <br><br>Lipitor is used for lowering high cholesterol and triglycerides in certain patients.
            ...
            <br><br>Lipitor is used to treat high cholesterol, and to lower the risk of stroke, heart attack, or other heart complications in people with type 2 diabetes, coronary heart disease, or other risk factors.
            <br>Lipitor is for use in adults and children who are at least 10 years old.
            <br><br>
            <b>Before taking this medicine</b>
            <br>You should not use Lipitor if you are allergic to atorvastatin, or if you have:
            <br>
            <ul type="disc">
                <li align="left">liver disease; or
                <li align="left">if you are pregnant or breast-feeding.
            </ul>
            <br>Atorvastatin can harm an unborn baby or cause birth defects. Do not use if you are pregnant. Stop taking Lipitor and tell your doctor right away if you become pregnant. Use effective birth control to prevent pregnancy while you are taking this medicine.
            <br>Atorvastatin may pass into breast milk and could harm a nursing baby. Do not breast-feed while you are taking Lipitor.
