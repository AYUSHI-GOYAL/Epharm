...
<html>
    ...
    <body bgcolor="D8FCB7">
        ...
        <img src="WEB-CONTENT/Oxycodone.jpg" class="image" alt="Oxycodone" style="width:300px;height:310px;border:0">
        
        <font class="myfont" color=black>   
          OXYCODONE    
        </font>
        <font class="myfont1" color=black> 
            <br> OxyNorm liquid contains oxycodone hydrochloride.
            <br>Oxycodone belongs to a group of medicines called opioid analgesics. 
            <br>OxyNorm liquid is used to relieve moderate to severe pain.
        </font>
        <form method="post" action="shopping_bag.jsp" name="f" id="example1">
            ...
            <% session.setAttribute("product_name","Oxycodone"); %>
        </form>
        <script>
                function myFunction(){
                    alert("Product added !");
        ...
        <form id="example2">
            ...
            <p align="left">
                ...
                <br><br><b>How to use  Oxycodone</b>
